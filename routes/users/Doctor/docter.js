...
doctor.get('/patient', (req,res) => {
    ...
    const sql = `select * from (select * from hospitalmanagementsystem.appoinment as p inner join hospitalmanagementsystem.assign_doctor as ad using (app_id) LIMIT 0, 1000) as q where q.doctor_id=${doctor_id};`
